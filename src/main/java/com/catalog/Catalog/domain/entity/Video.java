...
public class Video extends BaseEntity {
    ...
    public void setYearLaunched(Integer yearLaunched) {
        ...
        if (yearLaunched > currentYear)
            throw new IllegalArgumentException("yearLaunched is greater than currentYear");
    ...
    public void addVideoFile(VideoFile videoFile) {
        if (videoFile == null)
            throw new IllegalArgumentException("videoFile is marked non-null but is null");
        this.videoFiles.add(videoFile);
    }

    public void removeCastMember(VideoFile videoFile) {
        if (videoFile == null)
            throw new IllegalArgumentException("videoFile is marked non-null but is null");
